...
% ii. (optional) Usage metrics and costs of the experiment.
	...
	\label{subsubsec:scalability}
		The minimum requirements of running 5 servers, 100 clients and 20 dragons were fulfilled. 
		As discussed earlier, 5 servers were ran on 5 nodes of the DAS4 super computer and 100 clients in bunches of 50 on 2 nodes. 
		No tests were performed that went beyond this setting, but we believe we that the limit was not reached yet. Testing the scalability further is recommended for future work.
