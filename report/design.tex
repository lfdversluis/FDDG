...
\label{subsubsec:load_balancing}
	...
	There are plenty of load balancing algorithms for example \cite{wolff2001dynamic} and \cite{ballard2000client}, but due to time constrains this is something we consider future work.
