...
In this chapter, the design of the system is explained. The focus of section \ref{subsec:system_overview} will be the overview of the implemented system.
Here, the architecture of the system is discussed, what fault-tolerance mechanism is being used and how the system replicate the game over multiple distributed servers. 
...
The distributed system that has been designed consists of several server nodes and is built to deal with at least 20 players on each server. 
...
When the client request (1) is lost, the action will not be performed. 
